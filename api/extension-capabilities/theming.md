...
- **Icon Theme**: A mapping from file type / file name to images. The file icon
  is displayed across the VS Code UI in places such as File Explorer, Quick Open
  List, and Editor Tab.
...
- Associate files to these unique icon identifiers by filenames or file language
  types.
