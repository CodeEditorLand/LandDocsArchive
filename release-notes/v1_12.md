...
[`github.com/Microsoft/vscode`](HTTPS://github.com/Microsoft/vscode/issues),
2368 are feature requests. We won't run out of work anytime soon :-).
...
[`#25934`](HTTPS://github.com/Microsoft/vscode/issues/25934). The workaround is
to set: `"editor.disableTranslate3d": true` in user settings (this produces a
...
[`Insiders`](HTTPS://code.visualstudio.com/insiders) build applies this
workaround and clears `LC_ALL`.
