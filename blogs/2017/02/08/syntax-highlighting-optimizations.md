...
We'd then encode the `startIndex` (32 bits) and the `type` (16 bits) in 48 bits
...
It turned out quite nicely, we could flip a class name somewhere and immediately
